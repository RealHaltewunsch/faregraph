const I18N = {
  ...
  en: {
    ...
    departEarliest: 'Earliest departure', departLatest: 'Latest departure', minDestinationDays: 'Min. stay at destination (calendar days)', maxDestinationDays: 'Max. stay at destination (calendar days)', minOutboundFlights: 'Min. flights per outbound route', maxOutboundFlights: 'Max. flights per outbound route', minReturnFlights: 'Min. flights per return route', maxReturnFlights: 'Max. flights per return route', maxArrivalDifference: 'Max. arrival difference (h)', maxReturnDifference: 'Max. return-flight difference (calendar days)',
