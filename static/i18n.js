const I18N = {
  de: {
    ...
    routeDepartEarliest: 'Reisebeginn frühestens', routeDepartLatest: 'Reisebeginn spätestens', routeMinTripDays: 'Min. Reisedauer (Tage)', routeMaxTripDays: 'Max. Reisedauer (Tage)', helpRouteTripDays: 'Gemessen vom ersten Abflug bis zur letzten Ankunft. Die Route muss innerhalb dieses Bereichs liegen.',
    ...
    deleteFailed: 'Löschen fehlgeschlagen:', deleted: 'Suchauftrag und Flugdaten gelöscht', jobStarted: 'Suchauftrag gestartet', jobRepeated: 'Neuer Suchauftrag mit gleichen Einstellungen gestartet', invalidDateRange: 'Der späteste Start darf nicht vor dem frühesten Start liegen.', invalidRouteDateRange: 'Der späteste Reisebeginn darf nicht vor dem frühesten Reisebeginn liegen.', dateRangeTooLong: 'Das Startfenster darf höchstens 92 Tage (etwa drei Monate) umfassen.', invalidTripDays: 'Min. Reisetage darf Max. Reisetage nicht überschreiten.', error: 'Fehler:',
  ...
  en: {
    ...
    routeDepartEarliest: 'Earliest trip start', routeDepartLatest: 'Latest trip start', routeMinTripDays: 'Min. trip duration (days)', routeMaxTripDays: 'Max. trip duration (days)', helpRouteTripDays: 'Measured from the first departure to the final arrival. The route must fall within this duration range.',
    ...
    deleteFailed: 'Deletion failed:', deleted: 'Search job and flight data deleted', jobStarted: 'Search job started', jobRepeated: 'New search job started with the same settings', invalidDateRange: 'The latest departure must not be before the earliest departure.', invalidRouteDateRange: 'The latest trip start must not be before the earliest trip start.', dateRangeTooLong: 'The departure window may span no more than 92 days (about three months).', invalidTripDays: 'Min. trip days must not exceed max. trip days.', error: 'Error:',
