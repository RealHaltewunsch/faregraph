const I18N = {
  de: {
    ...
    deleteFailed: 'Löschen fehlgeschlagen:', deleted: 'Suchauftrag und Flugdaten gelöscht', jobStarted: 'Suchauftrag gestartet', jobRepeated: 'Neuer Suchauftrag mit gleichen Einstellungen gestartet', error: 'Fehler:',
  ...
  en: {
    ...
    deleteFailed: 'Deletion failed:', deleted: 'Search job and flight data deleted', jobStarted: 'Search job started', jobRepeated: 'New search job started with the same settings', error: 'Error:',
